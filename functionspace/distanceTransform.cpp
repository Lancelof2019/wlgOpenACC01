...
#pragma acc enter data copyin(matArr,visArr,plots,matArr.matImg[:rows][:cols],visArr.matImg[:rows][:cols],plots.matImg[:rows][:cols])
...
// string filename21="../test21new.txt";
